# Code copied from: https://github.com/DLR-MF-DAS/SSL4EO-S12-v1.1/tree/main
# Changes to the code: Added reference to source and license text
# Avaliable under the Apache 2.0 license
#                                  Apache License
